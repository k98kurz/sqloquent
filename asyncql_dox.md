...
##### `async chunk(number: int) -> Generator[list[AsyncModelProtocol] | list[AsyncJoinedModelProtocol] | list[RowProtocol], None, None]:`
...
##### `async query() -> AsyncQueryBuilderProtocol | None:`
